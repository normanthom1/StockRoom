...
urlpatterns = [
    ...
    path("setup/skip/", views.setup_skip, name="setup_skip"),
    path("setup/draft/", views.setup_draft, name="setup_draft"),
    path("setup/draft/confirm/", views.setup_draft_confirm, name="setup_draft_confirm"),
    ...
    path("invoices/batch/<int:pk>/undo/", views.invoice_batch_undo, name="invoice_batch_undo"),
    path("invoices/line/<int:pk>/price/", views.invoice_line_price, name="invoice_line_price"),
    path("item/<int:pk>/price/undo/", views.item_price_undo, name="item_price_undo"),
    ...
    path("tax/", views.tax_year, name="tax_year"),
    path("tax/document/<int:pk>/", views.invoice_document, name="invoice_document"),
    path("export/tax-year.csv", views.export_tax_year, name="export_tax_year"),
